...
# ===== 第6章批量消融（由 scripts/ch6_batch_experiments.py 临时改写；默认不影响正常运行）=====
# 取值：'none' | 'no_competition' | 'no_zone' | 'no_followup'
# no_competition：打分中竞争惩罚恒为 0
# no_zone：区域前瞻分不参与打分，即时效率 0.75 + 后续潜力 0.25（与论文 6.4 描述一致）
# no_followup：后续接单潜力不参与打分，即时效率 0.75 + 区域前瞻 0.25
